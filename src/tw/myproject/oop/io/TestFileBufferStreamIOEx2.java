...
public class TestFileBufferStreamIOEx2 {
	...
	public static void main(String[] args) throws IOException {
		...
		FileOutputStream fos1 = new FileOutputStream("c:/temp/test/data.txt");
		BufferedOutputStream bos1 = new BufferedOutputStream(fos1);
		
		//BufferedOutputStream bos1 = new BufferedOutputStream(new FileOutputStream("c:/temp/test/data.txt"));
